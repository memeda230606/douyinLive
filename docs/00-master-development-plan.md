...
```yaml
schema_version: 1
updated_at: "2026-07-23T14:19:00+08:00"
authoritative_workspace: "GJS-20250801EFK:D:\douyinLive"
last_verified_branch: "main"
last_verified_head: "56ee104a20396799ccebfa024aaaec5305678b1b"
...
expected_dirty_paths:
  - "P6-UPD-003 的 0.2.2 引导兼容键、正式卸载键校验、安装矩阵、版本与证据记录。"
blockers:
  - "0.2.1 stable 已按用户授权发布，但安装前发现 0.2.0 更新助手校验的卸载键名与正式安装器实际键名不一致；不可变 0.2.1 不覆盖，必须发布更高的 0.2.2 引导修复后再升级。"
...
resume_instruction: "完成 0.2.2 兼容安装器和新版助手正式键修复、全量门禁与精确 tag；先发布/回读 canary，再把 stable 前移到 0.2.2，随后让现有 0.2.0 执行真实自动升级并开始 24 小时观察。"
```
...
| P6-UPD-003 | 0.2.x 真实升级、回滚、24 小时观察与 stable 提升 | 2 | P6-UPD-002 | `IN_PROGRESS` | 0.2.1 canary/stable 发布完成；安装前发现 0.2.0 助手错误校验 `DouyinLiveDouyinLiveDesktop`，正式安装器实际写 `DouyinLiveDesktop`，已阻止已知失败安装并转为不可变 0.2.2 修复 | 构建/发布 0.2.2，执行真实升级/失败恢复与 24 小时观察 |
