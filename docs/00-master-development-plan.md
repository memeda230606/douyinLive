...
```yaml
schema_version: 1
updated_at: "2026-07-17T14:45:09+08:00"
authoritative_workspace: "GJS-20250801EFK:D:\douyinLive"
last_verified_branch: "main"
last_verified_head: "b3fd399ab81c3bdcc7c2ea0b44c309a4cd0584f0"
...
**退出标准**：连续两小时测试无未受控退出；断网和 FFmpeg 崩溃后按策略恢复；下播后场次正确收尾。
...
| REC-001 | 自动分片录制视频和音频 | 02 | 两小时录制与媒体探测 |
...
| 长期运行资源泄漏 | 有界队列、上下文取消、goroutine/句柄基线与 soak test |
