...
```yaml
schema_version: 1
updated_at: "2026-07-23T14:05:00+08:00"
authoritative_workspace: "GJS-20250801EFK:D:\douyinLive"
last_verified_branch: "main"
last_verified_head: "54172c638bf43f33a481a8319cae81e66bf57218"
...
blockers:
  - "P6-UPD-002 的干净精确 v0.2.0 正式产物和签名信封已生成；需要用户在目标 Windows 环境人工运行安装器完成引导安装。"
...
| P6-UPD-002 | 生成并人工安装 0.2.0 自动更新引导版 | 2 | P6-UPD-001 | `BLOCKED` | 精确 `v0.2.0`、dirty=false 正式构建、Ed25519 信封和正式 NSIS 7/7 已通过；等待用户人工安装 | 用户运行正式安装器并确认首次启动后进入 P6-UPD-003 |
